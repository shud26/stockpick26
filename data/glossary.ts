...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    termEn: 'Portfolio Mix',
    definition: 'How you divide your investments among stocks, bonds, cash, and other asset classes',
    description: 'Asset allocation is the single most important investment decision you\'ll make. Studies show it determines over 90% of your portfolio\'s performance over time—more than which specific stocks you pick. The classic rule of thumb: subtract your age from 110 to get your stock percentage (a 30-year-old would be 80% stocks, 20% bonds). Younger investors can afford more risk (more stocks), while older investors need stability (more bonds). Rebalancing once or twice a year keeps your allocation on track.',
    example: 'Age 30 aggressive: 80% stocks, 15% bonds, 5% cash. Age 60 conservative: 40% stocks, 50% bonds, 10% cash.',
    category: 'basic',
    relatedTerms: ['diversification', 'etf', 'index'],
  },
  {
    slug: 'drip',
    term: 'DRIP',
    termEn: 'Dividend Reinvestment Plan',
    definition: 'Automatically using dividend payments to buy more shares of the same stock',
    description: 'A DRIP takes your dividend payments and uses them to purchase additional shares—sometimes even fractional shares—without you lifting a finger. This creates a compounding snowball effect: more shares → more dividends → even more shares. Most brokers offer DRIP for free. Over decades, reinvested dividends can account for a massive portion of your total returns. Warren Buffett\'s Berkshire Hathaway doesn\'t pay dividends, but for dividend stocks, DRIP is one of the most powerful wealth-building tools.',
    example: 'You own 100 shares of Coca-Cola at $60. Quarterly dividend = $0.46/share = $46. DRIP buys 0.77 more shares. Next quarter you earn dividends on 100.77 shares. Repeat for 30 years.',
    category: 'dividend',
    relatedTerms: ['dividend', 'dividend-yield', 'dividend-stock', 'dollar-cost-averaging'],
  },
  {
    slug: 'rsi',
    term: 'RSI',
    termEn: 'Relative Strength Index',
    definition: 'A momentum indicator (0-100) that measures whether a stock is overbought or oversold',
    description: 'RSI compares the magnitude of recent gains to recent losses to determine if a stock has been pushed too far in one direction. RSI above 70 = overbought (price may have risen too fast, could pull back). RSI below 30 = oversold (price may have fallen too much, could bounce back). It\'s one of the most popular technical indicators. But be careful—a stock can stay overbought for weeks during a strong uptrend. RSI works best when combined with other indicators, not alone.',
    example: 'Tesla\'s RSI hits 85 after a 40% rally in 2 weeks. That\'s heavily overbought. Doesn\'t mean it\'ll crash tomorrow, but the risk of a pullback is elevated. If RSI drops to 25 after a selloff, it might be oversold and due for a bounce.',
    category: 'analysis',
    relatedTerms: ['technical-analysis', 'moving-average', 'support-resistance'],
  },
  {
    slug: 'volume',
    term: 'Volume',
    ...
    description: 'Volume tells you how many shares changed hands. High volume means lots of interest—the move is significant. Low volume means fewer traders care—the move might not last. A price breakout on high volume is more trustworthy than one on low volume. Average daily volume helps you gauge liquidity: can you buy or sell quickly without moving the price? Stocks with under 100K daily volume can be hard to trade without slippage.',
    example: 'Apple averages 60 million shares/day. If volume suddenly spikes to 200 million on an earnings day, that\'s a massive increase in activity—the price move is backed by real conviction.',
    category: 'trading',
    relatedTerms: ['bid-ask-spread', 'market-order', 'limit-order'],
  },
  {
    slug: 'bonds',
    term: 'Bonds',
    termEn: 'Fixed Income Securities',
    definition: 'Loans you make to governments or companies that pay you fixed interest over time',
    description: 'When you buy a bond, you\'re lending money. The borrower (government or corporation) promises to pay you regular interest (called the coupon) and return your principal at maturity. Government bonds (US Treasuries) are considered the safest investments. Corporate bonds pay higher interest but carry more risk. Bonds generally move opposite to stocks—when stocks crash, investors flee to bonds for safety. That\'s why portfolios mix both: stocks for growth, bonds for stability.',
    example: 'Buy a 10-year US Treasury bond for $1,000 with 4% coupon. You receive $40/year in interest for 10 years, then get your $1,000 back. Total earned: $400 in interest.',
    category: 'basic',
    relatedTerms: ['asset-allocation', 'diversification', 'dividend-yield'],
  },
];
